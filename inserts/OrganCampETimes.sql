...
-- Criar campeonato
INSERT INTO Campeonato (idCampeonato, Organizador_Pessoa_idPessoa, nome) VALUES (1, 21, 'Campeonato 1');
...
-- Estádios do Time 2
INSERT INTO Estadio (idEstadio, nome, Time_idTime) VALUES (2, 'Arena das Dunas', 2);
INSERT INTO Endereco_Estadio (Estadio_idEstadio, cep, rua, numero) VALUES (2, '23456789', 'Rua Estádio 2', 200);

-- Estádios do Time 3
INSERT INTO Estadio (idEstadio, nome, Time_idTime) VALUES (3, 'Curral do mequinha', 3);
INSERT INTO Endereco_Estadio (Estadio_idEstadio, cep, rua, numero) VALUES (3, '34567890', 'Rua Estádio 3', 300);

-- Estádios do Time 4
INSERT INTO Estadio (idEstadio, nome, Time_idTime) VALUES (4, 'Barretão', 4);
